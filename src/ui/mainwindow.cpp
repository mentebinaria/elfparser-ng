...
void MainWindow::parser(QString filename)
{
  ...
  m_tableItems.push_back(tableItem);
  tableItem = new QTableWidgetItem(QString::number(m_parser->getElfHeader().getSectionOffset()));
...
void MainWindow::on_ButtonFindTableSection_triggered()
{
  ...
  bool done;
  QString value = QInputDialog::getText(this, tr("Find Section"),
...
void MainWindow::on_ButtonFindTableSymbols_triggered()
{
  ...
  bool done;
  QString value = QInputDialog::getText(this, tr("Find Symbols..."),
                                        tr("Find:"), QLineEdit::Normal,
                                        nullptr, &done);
  if (done)
  {
...
void MainWindow::on_ButtonFindTablePrograms_triggered()
{
  ...
  bool done;
  QString value = QInputDialog::getText(this, tr("Find Programs..."),
                                        tr("Find:"), QLineEdit::Normal,
                                        nullptr, &done);
